...
public class DriveModule {
    ...
    public DriveModule(Robot robot, ModuleSide moduleSide) {
        ...
        if (moduleSide == ModuleSide.RIGHT) {
            ...
            motor2 = robot.hardwareMap.get(DcMotorEx.class, "R2b");
            Encoder = robot.hardwareMap.get(DcMotorEx.class, "EncoderB");
            ...
            motor2 = robot.hardwareMap.get(DcMotorEx.class, "M2");
            Encoder = robot.hardwareMap.get(DcMotorEx.class, "EncoderA");
    ...
    public Angle getCurrentOrientation() {
        ...
        double rawAngle = (double)(Encoder.getCurrentPosition()/ 8192) * 360;; //motor2-motor1 makes ccw positive (?)
